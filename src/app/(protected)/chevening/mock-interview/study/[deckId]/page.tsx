...
const CATEGORY_COLORS: Record<string, string> = {
    ...
    consistency: "bg-emerald-100 text-emerald-700",
};
...
export default function StudyPage({ params }: { params: Promise<{ deckId: string }> }) {
    ...
    const handleExit = useCallback(() => {
        ...
        router.push("/chevening/mock-interview");
    ...
    if (!currentCard) {
        return (
            <div className="text-center py-20">
                ...
                <Button onClick={() => router.push("/chevening/mock-interview")}>
                    Voltar
                </Button>
            </div>
        );
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-6">
                ...
                >
                    ...
                    >
                        <div className="flex items-center gap-2 mb-6">
                            ...
                            {currentCard.relatedEssay && (
                                <Badge variant="outline">
                                    Essay {currentCard.relatedEssay}: {ESSAY_LABELS[currentCard.relatedEssay]}
                                </Badge>
                            )}
                        </div>
            ...
            <p className="text-center text-xs text-muted-foreground">
                Use ← → para navegar • Espaço para virar • ESC para sair
            </p>
