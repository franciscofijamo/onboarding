...
- [x] **2.1. Internacionalização Completa (PT-MZ) (Audit 1.1, 2.3, 2.8, 2.10)**
...
- [x] **2.2. Normalização de Fit Scores a 100% (Audit 2.6, 5.4)**
...
- [x] **2.3. Sistema Centralizado de Formatação de Datas (Audit 5.3)**
...
- [x] **2.4. Centralização do System Type Pipeline (Audit 3.6)**
...
- [x] **3.1. Estado "Já Candidatado" no Job Board (Audit 2.11)**
...
- [x] **3.2. Botões Interativos na Application Kanban Candidato (Audit 2.4, 2.5)**
...
- [x] **3.3. Confirmações de Acções de Risco Recrutador (Audit 3.2, 3.3, 3.9, 4.1, 4.2)**
...
- [x] **3.4. Melhorias no Formulário Nova Vaga (Audit 3.7, 3.8)**
...
- [x] **3.5. Transparência Financeira - Sistema Billing (Audit 2.9, 2.13, 2.14, 4.3)**
...
- [x] **3.6. Submissão de Flow Scenarios "RECORDED" (Audit 2.11)**
...
- [x] **4.1. Refatoração Visual Consistente de Components (Audit 1.3, 5.1, 5.2, 5.4)**
...
- [x] **4.2. Drag-and-Drop Fallback Pipeline e Links Rápidos (Audit 3.4, 3.5)**
